...
static std::map<std::string, std::string> g_locale_sv = {
...
std::string get_text_sv(const std::string& key) {
    auto it = g_locale_sv.find(key);
    return it != g_locale_sv.end() ? it->second : key;
}
