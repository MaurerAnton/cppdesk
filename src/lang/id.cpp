...
static std::map<std::string, std::string> g_locale_id = {
...
std::string get_text_id(const std::string& key) {
    auto it = g_locale_id.find(key);
    return it != g_locale_id.end() ? it->second : key;
}
