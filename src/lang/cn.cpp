...
static std::map<std::string, std::string> g_locale_cn = {
...
std::string get_text_cn(const std::string& key) {
    auto it = g_locale_cn.find(key);
    return it != g_locale_cn.end() ? it->second : key;
}
