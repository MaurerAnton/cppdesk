...
static std::map<std::string, std::string> g_locale_tw = {
...
std::string get_text_tw(const std::string& key) {
    auto it = g_locale_tw.find(key);
    return it != g_locale_tw.end() ? it->second : key;
}
