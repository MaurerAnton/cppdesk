...
static std::map<std::string, std::string> g_locale_sr = {
...
std::string get_text_sr(const std::string& key) {
    auto it = g_locale_sr.find(key);
    return it != g_locale_sr.end() ? it->second : key;
}
