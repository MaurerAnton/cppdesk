...
static std::map<std::string, std::string> g_locale_pl = {
...
std::string get_text_pl(const std::string& key) {
    auto it = g_locale_pl.find(key);
    return it != g_locale_pl.end() ? it->second : key;
}
