...
static std::map<std::string, std::string> g_locale_fi = {
...
std::string get_text_fi(const std::string& key) {
    auto it = g_locale_fi.find(key);
    return it != g_locale_fi.end() ? it->second : key;
}
