...
static std::map<std::string, std::string> g_locale_he = {
...
std::string get_text_he(const std::string& key) {
    auto it = g_locale_he.find(key);
    return it != g_locale_he.end() ? it->second : key;
}
