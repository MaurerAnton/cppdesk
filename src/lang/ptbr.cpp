...
static std::map<std::string, std::string> g_locale_ptbr = {
...
std::string get_text_ptbr(const std::string& key) {
    auto it = g_locale_ptbr.find(key);
    return it != g_locale_ptbr.end() ? it->second : key;
}
