...
static std::map<std::string, std::string> g_locale_sk = {
...
std::string get_text_sk(const std::string& key) {
    auto it = g_locale_sk.find(key);
    return it != g_locale_sk.end() ? it->second : key;
}
