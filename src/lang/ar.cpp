...
static std::map<std::string, std::string> g_locale_ar = {
...
std::string get_text_ar(const std::string& key) {
    auto it = g_locale_ar.find(key);
    return it != g_locale_ar.end() ? it->second : key;
}
