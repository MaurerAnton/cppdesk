...
static std::map<std::string, std::string> g_locale_uk = {
...
std::string get_text_uk(const std::string& key) {
    auto it = g_locale_uk.find(key);
    return it != g_locale_uk.end() ? it->second : key;
}
