...
static std::map<std::string, std::string> g_locale_cs = {
...
std::string get_text_cs(const std::string& key) {
    auto it = g_locale_cs.find(key);
    return it != g_locale_cs.end() ? it->second : key;
}
