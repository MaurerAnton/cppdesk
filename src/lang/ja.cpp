...
static std::map<std::string, std::string> g_locale_ja = {
...
std::string get_text_ja(const std::string& key) {
    auto it = g_locale_ja.find(key);
    return it != g_locale_ja.end() ? it->second : key;
}
