...
static std::map<std::string, std::string> g_locale_th = {
...
std::string get_text_th(const std::string& key) {
    auto it = g_locale_th.find(key);
    return it != g_locale_th.end() ? it->second : key;
}
