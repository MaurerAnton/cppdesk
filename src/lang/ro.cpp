...
static std::map<std::string, std::string> g_locale_ro = {
...
std::string get_text_ro(const std::string& key) {
    auto it = g_locale_ro.find(key);
    return it != g_locale_ro.end() ? it->second : key;
}
