...
static std::map<std::string, std::string> g_locale_vi = {
...
std::string get_text_vi(const std::string& key) {
    auto it = g_locale_vi.find(key);
    return it != g_locale_vi.end() ? it->second : key;
}
