...
static std::map<std::string, std::string> g_locale_sq = {
...
std::string get_text_sq(const std::string& key) {
    auto it = g_locale_sq.find(key);
    return it != g_locale_sq.end() ? it->second : key;
}
