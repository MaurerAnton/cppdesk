...
static std::map<std::string, std::string> g_locale_hu = {
...
std::string get_text_hu(const std::string& key) {
    auto it = g_locale_hu.find(key);
    return it != g_locale_hu.end() ? it->second : key;
}
