...
static std::map<std::string, std::string> g_locale_hr = {
...
std::string get_text_hr(const std::string& key) {
    auto it = g_locale_hr.find(key);
    return it != g_locale_hr.end() ? it->second : key;
}
