...
static std::map<std::string, std::string> g_locale_nl = {
...
std::string get_text_nl(const std::string& key) {
    auto it = g_locale_nl.find(key);
    return it != g_locale_nl.end() ? it->second : key;
}
