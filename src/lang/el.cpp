...
static std::map<std::string, std::string> g_locale_el = {
...
std::string get_text_el(const std::string& key) {
    auto it = g_locale_el.find(key);
    return it != g_locale_el.end() ? it->second : key;
}
