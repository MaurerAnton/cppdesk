...
static std::map<std::string, std::string> g_locale_fr = {
...
std::string get_text_fr(const std::string& key) {
    auto it = g_locale_fr.find(key);
    return it != g_locale_fr.end() ? it->second : key;
}
