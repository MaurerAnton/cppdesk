...
static std::map<std::string, std::string> g_locale_bg = {
...
std::string get_text_bg(const std::string& key) {
    auto it = g_locale_bg.find(key);
    return it != g_locale_bg.end() ? it->second : key;
}
