...
static std::map<std::string, std::string> g_locale_tr = {
...
std::string get_text_tr(const std::string& key) {
    auto it = g_locale_tr.find(key);
    return it != g_locale_tr.end() ? it->second : key;
}
