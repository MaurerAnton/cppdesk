...
static std::map<std::string, std::string> g_locale_da = {
...
std::string get_text_da(const std::string& key) {
    auto it = g_locale_da.find(key);
    return it != g_locale_da.end() ? it->second : key;
}
