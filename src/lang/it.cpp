...
static std::map<std::string, std::string> g_locale_it = {
...
std::string get_text_it(const std::string& key) {
    auto it = g_locale_it.find(key);
    return it != g_locale_it.end() ? it->second : key;
}
