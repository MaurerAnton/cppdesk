...
static std::map<std::string, std::string> g_locale_ko = {
...
std::string get_text_ko(const std::string& key) {
    auto it = g_locale_ko.find(key);
    return it != g_locale_ko.end() ? it->second : key;
}
