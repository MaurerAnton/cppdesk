...
static std::map<std::string, std::string> g_locale_sl = {
...
std::string get_text_sl(const std::string& key) {
    auto it = g_locale_sl.find(key);
    return it != g_locale_sl.end() ? it->second : key;
}
