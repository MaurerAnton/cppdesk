...
static std::map<std::string, std::string> g_locale_ru = {
...
std::string get_text_ru(const std::string& key) {
    auto it = g_locale_ru.find(key);
    return it != g_locale_ru.end() ? it->second : key;
}
